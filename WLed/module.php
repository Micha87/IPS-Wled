<?php
	...
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',0,"Solid", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',1,"Blink", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',2,"Breathe", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',3,"Wipe", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',4,"Wipe Random", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',5,"Random Colors", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',6,"Sweep", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',7,"Dynamic", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',8,"Colorloop", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',9,"Rainbow", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',10,"Scan", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',11,"Dual Scan", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',12,"Fade", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',13,"Theater", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',14,"Theater Rainbow", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',15,"Running", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',16,"Saw", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',17,"Twinkle", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',18,"Dissolve", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',19,"Dissolve Rnd", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',20,"Sparkle", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',21,"Dark Sparkle", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',22,"Sparkle+", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',23,"Strobe", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',24,"Strobe Rainbow", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',25,"Mega Strobe", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',26,"Blink Rainbow", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',27,"Android", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',28,"Chase", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',29,"Chase Random", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',30,"Chase Rainbow", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',31,"Chase Flash", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',32,"Chase Flash Rnd", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',33,"Rainbow Runner", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',34,"Colorful", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',35,"Traffic Light", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',36,"Sweep Random", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',37,"Running 2", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',38,"Red & Blue", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',39,"Stream", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',40,"Scanner", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',41,"Lighthouse", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',42,"Fireworks", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',43,"Rain", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',44,"Merry Christmas", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',45,"Fire Flicker", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',46,"Gradient", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',47,"Loading", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',48,"Police", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',49,"Police All", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',50,"Two Dots", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',51,"Two Areas", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',52,"Circus", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',53,"Halloween", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',54,"Tri Chase", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',55,"Tri Wipe", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',56,"Tri Fade", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',57,"Lightning", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',58,"ICU", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',59,"Multi Comet", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',60,"Dual Scanner", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',61,"Stream 2", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',62,"Oscillate", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',63,"Pride 2015", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',64,"Juggle", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',65,"Palette", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',66,"Fire 2012", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',67,"Colorwaves", "", -1);	
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',68,"BPM", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',69,"Fill Noise", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',70,"Noise 1", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',71,"Noise 2", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',72,"Noise 3", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',73,"Noise 4", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',74,"Colortwinkle", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',75,"Lake", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',76,"Meteor", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',77,"Smooth Meteor", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',78,"Railway", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',79,"Ripple", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',80,"Twinklefox", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',81,"Twinklecat", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',82,"Halloween Eyes", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',83,"Solid Pattern", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',84,"Solid Pattern Tri", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',85,"Spots", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',86,"Spots Fade", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',87,"Glitter", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',88,"Candle", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',89,"Fireworks Starburst", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',90,"Fireworks 1D", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',91,"Bouncing Balls", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',92,"Sinelon", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',93,"Sinelon Dual", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',94,"Sinelon Rainbow", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',95,"Popcorn", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',96,"Drip", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',97,"Plasma", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',98,"Percent", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',99,"Ripple Rainbow", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',100,"Heartbeat", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',101,"Pacifica", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',102,"Candle Multi", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',103,"Solid Glitter", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',104,"Sunrise", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',105,"Phased", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',106,"Twinkle Up", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',107,"Noise Pal", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',108,"Sinewave", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',109,"Phased Noise", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',110,"Flow", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',111,"Chunchun", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',112,"Dancing Shadows", "", -1);
	IPS_SetVariableProfileAssociation('Wled.FastLED_palette',113,"Washing machine", "", -1);	
    }
