<?php
	class WLed extends IPSModule{
        ...
        //Variablen anlegen
			...
			$this->RegisterVariableBoolean("Nightlight_active", "Nightlight active",'~Switch',20);
			$this->EnableAction('Nightlight_active');	
       		$this->RegisterVariableBoolean("Nightlight_Fade_type", "Nightlight Fade type", "",22);
			$this->RegisterVariableInteger("Nightlight_delay", "Nightlight delay", "",21);
			$this->EnableAction('Nightlight_delay');	
			$this->RegisterVariableInteger("Nightlight_target_brightness", "Nightlight target brightness", "",23);
			$this->EnableAction('Nightlight_target_brightness');
			$this->RegisterVariableInteger("Effect_index", "Effect index", "",30);
			$this->EnableAction('Effect_index');
			$this->RegisterVariableInteger("Effect_speed", "Effect speed", "~Intensity.255",31);
			$this->EnableAction('Effect_speed');
			$this->RegisterVariableInteger("Effect_intensity", "Effect intensity", "~Intensity.255",32);
